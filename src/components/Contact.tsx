              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4">
                  ...
                  <div className="flex space-x-4">
                    <Button variant="outline" size="icon" className="border-white/30 text-white hover:bg-white hover:text-sukino-green">
          ...
          <div className="space-y-6">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 h-96">
              <CardContent className="p-0 h-full">
                <div className="bg-gradient-to-br from-sukino-mint/20 to-sukino-sage/30 h-full rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <Button variant="outline" className="mt-4 border-white/30 text-white hover:bg-white hover:text-sukino-green">
                      Get Directions
                    </Button>
                  </div>
                </div>
        ...
        <div className="text-center mt-16 p-8 bg-white/10 rounded-2xl backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              variant="outline" 
              size="lg"
              className="border-white text-white hover:bg-white hover:text-sukino-green"
              onClick={() => {
            ...
            <Button 
              variant="sukino-soft" 
              size="lg"
              className="bg-white text-sukino-green hover:bg-sukino-mint"
              onClick={() => {
